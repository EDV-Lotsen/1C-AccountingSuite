...
Procedure ResultDetailProcessing(Item, Details, StandardProcessing)
	...
	If Structure <> Undefined And Structure.SalesPerson <> Undefined Then
	    ...
	    ReportForm = GetForm("Report.IncomeStatementSalesPersonAccrualBasisDetail.Form.ReportForm", ParametersStructure,, True);
...
Function ProcessDetailsAtServer(Val ReportRF, Val ResultRF, Val DetailsDataRF, Val UUID_RF)
	...
	ReportObject = FormDataToValue(ReportRF, Type("ReportObject.IncomeStatementSalesPersonAccrualBasisDetail"));
	ResultRF.Clear();                                                                              
