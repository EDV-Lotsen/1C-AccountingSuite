...
Procedure Posting(Cancel, Mode)
	...
	While Result.Next() Do
		...
		Message.Text=NStr("en = '" + Result.DocumentPresentation + ". Current amount " + Format(Max(Result.Amount, -Result.Amount), "NFD=2; NZ=") + " exceeds the amount, available for reconciliation " + Format(Max(Result.AvailableAmount, -Result.AvailableAmount), "NFD=2; NZ=") + "." + Chars.LF + "Please, use the Refresh button to update the tabular section!'");
