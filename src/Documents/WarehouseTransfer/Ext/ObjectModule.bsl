...
////////////////////////////////////////////////////////////////////////////////
// Warehouse transfer: Object module
//------------------------------------------------------------------------------
...
Procedure BeforeWrite(Cancel, WriteMode, PostingMode)
	...
	If WriteMode = DocumentWriteMode.Posting Then
		...
		If (Not ManualAdjustment) Then
			DocumentParameters = New Structure("Ref, PointInTime,   Location,     LineItems",
			                                    Ref, PointInTime(), LocationFrom, LineItems.Unload(, "Product, Quantity"));
			Documents.WarehouseTransfer.PrepareDataBeforeWrite(AdditionalProperties, DocumentParameters, Cancel);
		EndIf;
...
Procedure Posting(Cancel, Mode)
	...
	Documents.WarehouseTransfer.PrepareDataStructuresForPosting(Ref, AdditionalProperties, RegisterRecords);
...
Procedure UndoPosting(Cancel)
	...
	Documents.WarehouseTransfer.PrepareDataStructuresForPostingClearing(Ref, AdditionalProperties, RegisterRecords);
