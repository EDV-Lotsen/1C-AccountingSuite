...
Procedure CompanyOnChange(Item)
	...
	Object.AccruedPurchasesAccount = GeneralFunctions.GetAttributeValue(Object.Currency, "DefaultAccruedPurchasesAccount");
...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	//Title = "Goods receipt " + Object.Number + " " + Format(Object.Date, "DLF=D");
	...
	If Object.Currency.IsEmpty() Then
		...
		Object.AccruedPurchasesAccount = Object.Currency.DefaultAccruedPurchasesAccount;
