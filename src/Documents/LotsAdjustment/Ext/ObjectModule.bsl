...
Procedure Posting(Cancel, Mode)
	...
	Documents.LotsAdjustment.PrepareDataStructuresForPosting(Ref, AdditionalProperties, RegisterRecords);
...
Procedure UndoPosting(Cancel)
	...
	Documents.LotsAdjustment.PrepareDataStructuresForPostingClearing(Ref, AdditionalProperties, RegisterRecords);
